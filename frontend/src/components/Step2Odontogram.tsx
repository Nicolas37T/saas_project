        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-3 text-center">
              ...
              <p className="text-white font-bold text-lg">{odontogramItems.length}</p>
            </div>
            <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-3 text-center">
              <div className="flex items-center justify-center gap-1.5 mb-1">
              ...
              <p className="text-white font-bold text-lg">{totalTreatments}</p>
            </div>
            <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-3 text-center">
              <div className="flex items-center justify-center gap-1.5 mb-1">
              ...
              <p className="text-amber-400 font-bold text-lg">Bs. {totalPrice.toFixed(2)}</p>
            </div>
          </div>
          ...
          {/* ══════════════════════════════════════════════════════════ */}
          <div className="p-5 border-2 border-dashed border-blue-500/30 rounded-2xl bg-gradient-to-b from-blue-950/20 to-slate-950/40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  className="w-full h-10 rounded-md bg-slate-900 border border-slate-700 text-white text-sm px-3 appearance-none focus:ring-1 focus:ring-blue-500 outline-none"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  type="number"
                  placeholder="0"
                  className="bg-slate-900 border-slate-700 text-amber-400 font-bold focus:border-amber-500"
              ...
              <div className="space-y-1.5">
                ...
                <select
                  className="w-full h-10 rounded-md bg-slate-900 border border-slate-700 text-white text-sm px-3 appearance-none focus:ring-1 focus:ring-purple-500 outline-none"
            ...
            {!canAddTooth && (
              <p className="text-[11px] text-slate-600 text-center mt-2 italic">
            ...
            <div className="space-y-3">
              ...
              {odontogramItems.map((tooth, toothIdx) => {
                ...
                return (
                  <div
                    key={toothIdx}
                    className="border border-slate-800/60 rounded-xl overflow-hidden transition-all duration-300"
                  >
                    {/* Tooth Header */}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 mt-0.5">
                            ...
                            <span className="text-purple-400/70 text-[10px] font-semibold">
